...
func (t *RequestArguments) UnmarshalCBOR(r io.Reader) (err error) {
	*t = RequestArguments{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("RequestArguments: map struct too large (%d)", extra)
	}
...
func (t *CapabilityRequest) UnmarshalCBOR(r io.Reader) (err error) {
	*t = CapabilityRequest{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("CapabilityRequest: map struct too large (%d)", extra)
	}
...
func (t *RequestOK) UnmarshalCBOR(r io.Reader) (err error) {
	*t = RequestOK{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("RequestOK: map struct too large (%d)", extra)
	}
...
func (t *ClaimOK) UnmarshalCBOR(r io.Reader) (err error) {
	*t = ClaimOK{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("ClaimOK: map struct too large (%d)", extra)
	}
...
func (t *ConfirmArguments) UnmarshalCBOR(r io.Reader) (err error) {
	*t = ConfirmArguments{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("ConfirmArguments: map struct too large (%d)", extra)
	}
...
func (t *DelegateArguments) UnmarshalCBOR(r io.Reader) (err error) {
	*t = DelegateArguments{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("DelegateArguments: map struct too large (%d)", extra)
	}

...
// FromCommitmentAndSize converts a raw data commitment and unpadded length to a
// v2 piece multihash. The helpers UnpaddedSizeToV1TreeHeight and
// Fr32PaddedSizeToV1TreeHeight may help in computing tree height.
